...
class FaceRecogniser(object):
    ...
    def train(self,workDir,classifier,ldaDim):
        ...
        logger.info("Loading labels " + fname + " csv size: " +  str(os.path.getsize("/host/soldierforce/Documents/Developer/home_surveillance/system/generated-embeddings/reps.csv")))
